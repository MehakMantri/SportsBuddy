...
// MenuItem component with animation on hover
...
// Menu component that contains multiple MenuItem components
export const Menu = ({ setActive, children }) => {
  return (
    <nav
      onMouseLeave={() => setActive(null)} // Resets the state when mouse leaves
...
// HoveredLink component for links with hover effect
